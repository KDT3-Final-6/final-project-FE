...
const index = (props: Props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setAttachment(data.productThumbnail)
    }
    fetchData()
  }, [])
        ...
        <ProductTableStyle>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={6}>
                <CategoryStyle>
                  {categories[0].child.map((group, index) => (
                    <CategoryInputStyle key={index}>
            ...
            <tr>
              ...
              <td colSpan={6}>
                <CategoryStyle>
                  {categories[2].child.map((theme, index) => (
                    <CategoryInputStyle key={index}>
                ...
                <StatusBoxStyle>
                  <StatusStyle>
                    <input
                      ...
                      id="sale"
                      name="product-state"
                      defaultChecked={productDetail?.productStatus === '판매중' ? false : true}
                    />
            ...
            <tr>
              <th>간략 설명</th>
              <td colSpan={6}>
                <input type="text" defaultValue={productDetail?.productContent} />
              </td>
            </tr>
            <tr>
              <th>여행하는 나라</th>
              <td colSpan={6}>
                <input type="text" defaultValue={productDetail?.contentDetail} />
              </td>
            </tr>
          </tbody>
        </ProductTableStyle>
